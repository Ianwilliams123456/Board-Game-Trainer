// trainer.js - compiled from trainer.ts for quick prototyping (ES6-compatible)
...
function getMin(resource, fallback = 0) {
  return typeof resource.min === "number" ? resource.min : fallback;
}

function createFreshState(config, desiredPlayers) {
  ...
  return { turn: 1, phaseIndex: 0, activePlayer: 0, globals, players };
}
